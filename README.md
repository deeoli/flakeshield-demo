...
Generated by [`deeoli/flakeshield-action@v0.6.0-beta.3`](https://github.com/deeoli/flakeshield-action) in the [FlakeShield Demo workflow](.github/workflows/flakeshield.yml). Screenshots are cropped from real `outputs/flake_report.md` and `outputs/pr_comment.md` artifacts.
...
Push to `main` or open a PR to trigger the workflow (`deeoli/flakeshield-action@v0.6.0-beta.3`). Download artifacts for `outputs/flake_report.md` and `outputs/pr_comment.md`.
